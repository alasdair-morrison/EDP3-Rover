...
int main()
{
    ...
    float duty = 0.5;
    float dutyTurnRight = 0.40;
    float dutyTurnLeft = 0.40;
    powerLED.period(2);
    ...
    while (true) {
        ...
        if (leftValue == 1 && rightValue == 1 && rightTurnValue == 1 && middleIR == 1 && rightTurnValue == 0) {
            cornerRight(duty);
        }
        ...
        else if (leftValue == 0 && rightValue == 0 && middleIR == 0) {
            stop();
        }       
    }        
}    
